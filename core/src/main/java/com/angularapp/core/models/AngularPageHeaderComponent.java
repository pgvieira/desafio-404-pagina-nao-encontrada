...
/**
 * Defines the {@code AngularPageHeaderComponent} Sling Model used for the {@code angularapp/components/angular-page-header-component} component.
 * 
 */
@ConsumerType
public interface AngularPageHeaderComponent
