...
/**
 * Defines the {@code AngularPageFooterComponent} Sling Model used for the {@code angularapp/components/angular-page-footer-component} component.
 * 
 */
@ConsumerType
public interface AngularPageFooterComponent
