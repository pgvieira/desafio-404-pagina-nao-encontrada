...
/**
 * Defines the {@code AngularPageBodyComponent} Sling Model used for the {@code angularapp/components/angular-page-body-component} component.
 * 
 */
@ConsumerType
public interface AngularPageBodyComponent
